 ...
 * email, password, and passwordConfirmation set.
...
function createUser(req, res) {
  ...
  var info = db.prepare("INSERT INTO users (first, last, organization, role, email, crypted_password) values (?, ?, ?, ?, ?, ?);").run(first, last, organization, role, email, hash);
